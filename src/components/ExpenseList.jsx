...
import { Trash2, History, Receipt, Calendar, Tag } from 'lucide-react';

const CATEGORY_CONFIG = {
    food: { emoji: '🍔', label: 'Food', bgColor: 'bg-orange-100', textColor: 'text-orange-700' },
    travel: { emoji: '✈️', label: 'Travel', bgColor: 'bg-blue-100', textColor: 'text-blue-700' },
    stay: { emoji: '🏨', label: 'Stay', bgColor: 'bg-purple-100', textColor: 'text-purple-700' },
    utilities: { emoji: '⚡', label: 'Utilities', bgColor: 'bg-yellow-100', textColor: 'text-yellow-700' },
    other: { emoji: '📦', label: 'Other', bgColor: 'bg-gray-100', textColor: 'text-gray-700' },
};
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="flex items-center gap-2 flex-wrap">
                                        ...
                                        <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-xs font-medium ${category.bgColor} ${category.textColor}`}>
